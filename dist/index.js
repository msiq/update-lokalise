...
"use strict";
module.exports = JSON.parse('{"_from":"@lokalise/node-api@^7.2.0","_id":"@lokalise/node-api@7.2.0","_inBundle":false,"_integrity":"sha512-gxYBs1M8NcknWHWtS9RLXwtDPcvthKIIkliESAL7hOF7GRtUi9WzGmYy7T9og+RCFBecn5ZlQrl3C09E1efOAQ==","_location":"/@lokalise/node-api","_phantomChildren":{},"_requested":{"type":"range","registry":true,"raw":"@lokalise/node-api@^7.2.0","name":"@lokalise/node-api","escapedName":"@lokalise%2fnode-api","scope":"@lokalise","rawSpec":"^7.2.0","saveSpec":null,"fetchSpec":"^7.2.0"},"_requiredBy":["/"],"_resolved":"https://registry.npmjs.org/@lokalise/node-api/-/node-api-7.2.0.tgz","_shasum":"39b9ccc5a6b6bb19f8e1aab62018da26656ecf2a","_spec":"@lokalise/node-api@^7.2.0","_where":"/home/shahid/ILT/update-lokalise","author":{"name":"Lokalise group, Ilya Bodrov"},"bugs":{"url":"https://github.com/lokalise/node-lokalise-api/issues"},"bundleDependencies":false,"dependencies":{"got":"^11.8.3"},"deprecated":false,"description":"Official Lokalise API 2.0 Node.js client","devDependencies":{"@istanbuljs/nyc-config-typescript":"^1.0.1","@types/chai":"^4.2.22","@types/mocha":"^9.0.0","@types/node":"^17.0.0","@typescript-eslint/eslint-plugin":"^5.4.0","@typescript-eslint/parser":"^5.4.0","acorn":"^8.6.0","chai":"^4.2.0","dotenv":"^16.0.0","eslint":"^8.3.0","eslint-config-prettier":"^8.0.0","eslint-plugin-node":"^11.1.0","eslint-plugin-prettier":"^4.0.0","lodash":"^4.17.20","mocha":"^9.1.3","mocha-cassettes":"1.2.5","nyc":"^15.1","prettier":"^2.4.1","source-map-support":"^0.5.21","ts-mocha":"^9.0.1","typescript":"^4.5.2"},"directories":{"lib":"./src","test":"./test"},"engines":{"node":">=10"},"homepage":"https://lokalise.github.io/node-lokalise-api","keywords":["api","node","typescript","lokalise","client","client library"],"license":"BSD-3-Clause","main":"./index.js","name":"@lokalise/node-api","repository":{"type":"git","url":"git+https://github.com/lokalise/node-lokalise-api.git"},"scripts":{"build":"tsc","test":"tsc && nyc --reporter=lcov ts-mocha -p tsconfig.json --r source-map-support/register test/**/*.spec.ts --timeout 10000"},"typings":"./index.d.ts","version":"7.2.0"}');
...
class FileManager {
    path;
    extention = 'json';
    constructor(pathtofiles, extension) {
...
class LokaliseClient {
    ...
    constructor(apiToken) {
        this.api = new node_api_1.LokaliseApi({ apiKey: apiToken });
    }
     ...
     */
    async uploadFile(fileName, base64FileData) {
    ...
    async waitUntilFileUploading(processId, projectId) {
...
exports.default = LokaliseClient;
...
const lokaliseClient_1 = __importDefault(__nccwpck_require__(7510));
const fileManager_1 = __importDefault(__nccwpck_require__(2950));
async function run() {
    try {
        ...
        const lapi = new lokaliseClient_1.default('2348373fae9fb7fcf45be9c66e615bab824fb5b5');
        ...
        const fileManager = new fileManager_1.default(pathtofiles, extension);
...
const pkg = __nccwpck_require__(2661);
class ApiRequest {
